...
Character HeroBuilder::build_hero(const std::string&hero)
{
    ...
    Сharacterization characterization (build_hero_personality);
...
Сharacterization HeroBuilder::build_hero_personality(const std::string&hero)
{
    return Сharacterization;
}
